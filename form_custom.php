...
<div class="block_for_messages">
    ...
    <div id="form_cust">
        <h2>Форма личных данных</h2>
        <form action="save_customer.php" method="post" name="form_cust">
            <table>
                ...
                <tr>
				 ...
				 <tr>
				     <td> ID_пользователя: </td>
                    <td>
                        <input type="integer" name="user_id" required="required"><br>
                        <span id="valid_email_message" class="mesage_error"></span>
                    </td>
                </tr>
                <tr>
